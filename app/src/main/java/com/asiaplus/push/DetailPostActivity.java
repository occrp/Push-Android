...
import com.asiaplus.push.fragment.DetailPost;
...
public class DetailPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.asiaplus.push.R.layout.activity_detail_post);
        ...
        mPager = (ViewPager)findViewById(com.asiaplus.push.R.id.pager);
        mPager.setAdapter(mAdapter);
        mPager.setOffscreenPageLimit(2);
        int pageCount = mPager.getAdapter().getCount();
        mIndicator = (CirclePageIndicator) findViewById(com.asiaplus.push.R.id.indicator);
    ...
    private void initActionBar() {
        mToolbar = (Toolbar) findViewById(com.asiaplus.push.R.id.toolbar);
        mToolbar.setTitleTextColor(getResources().getColor(R.color.primary_dark_material_dark));
        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(null);
        getSupportActionBar().setDisplayUseLogoEnabled(true);
        getSupportActionBar().setLogo(com.asiaplus.push.R.mipmap.logo);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(com.asiaplus.push.R.menu.menu_detail_post, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id== com.asiaplus.push.R.id.action_share){
            doShare();
